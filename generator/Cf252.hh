 ...
 */
  ...
  public:
    ...
    HepLorentzVector GetCfNeutronMomentum(int n) const {return neutronE[n];}
    ...
    HepLorentzVector GetCfGammaMomentum(int n) const {return gammaE[n];}
     ...
     *  neutrons. */
    std::vector<HepLorentzVector> neutronE;
     ...
     *  each Cf decay, indexed from 0 to the total number of
     *  gammas. */
    std::vector<HepLorentzVector> gammaE;
